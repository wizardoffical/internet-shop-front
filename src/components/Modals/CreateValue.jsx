...
import { Context } from "../..";
import { createValue, fetchCategory } from "./../../http/deviceApi";
import { observer } from "mobx-react-lite";

const CreateValue = observer(({ show, onHide }) => {
  ...
  const addValue = () => {
    ...
    createValue(formData).then((data) => onHide());
  };
  return (
    <Modal
      show={show}
    ...
    >
      ...
      <Modal.Footer>
        ...
        <Button variant="outline-success" onClick={addValue}>
          Добавить
        </Button>
      </Modal.Footer>
    </Modal>
